...
* [Mudak](bears/mudak/README.md)
  ...
  * [Detections](bears/mudak/detections/README.md)
    * [Monitor - Veritas < v21.2](bears/mudak/detections/monitor-veritas-less-than-v21.2.md)
    * [Log (ndmp\ndmpsrvr) - ndmpd.cpp](bears/mudak/detections/log-ndmp-ndmpsrvr-ndmpd.cpp.md)
    * [Log (ndmp\ndmpsrvr) - Session](bears/mudak/detections/log-ndmp-ndmpsrvr-session.md)
    * [Log (ndmp\ndmpsrvr) - sslOpen Opening](bears/mudak/detections/log-ndmp-ndmpsrvr-sslopen-opening.md)
    * [Log (ndmp\ndmpsrvr) - sslOpen certinfo](bears/mudak/detections/log-ndmp-ndmpsrvr-sslopen-certinfo.md)
    * [Log (ndmp\ndmpsrvr) - ndmpRun](bears/mudak/detections/log-ndmp-ndmpsrvr-ndmprun.md)
    * [Log (ndmp\ndmpsrvr) - SetPreCommandEnvironment](bears/mudak/detections/log-ndmp-ndmpsrvr-setprecommandenvironment.md)
    * [Log (ndmp\ndmpsrvr) - BE Job](bears/mudak/detections/log-ndmp-ndmpsrvr-be-job.md)
    * [Log (ndmp\ndmpsrvr) - Pre/Post](bears/mudak/detections/log-ndmp-ndmpsrvr-pre-post.md)
    * [Log (ndmp\ndmpsrvr) - ndmp\_readit](bears/mudak/detections/log-ndmp-ndmpsrvr-ndmp\_readit.md)
...
* [RockPort](bears/rockport/README.md)
  ...
  * [Emulations](bears/rockport/emulations.md)
  * [Telemetry](bears/rockport/telemetry.md)
  * [Detections](bears/rockport/detections.md)
